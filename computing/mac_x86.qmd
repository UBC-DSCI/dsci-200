---
title: "{{< fa brands apple >}} MacOS x86"
---
...
In this course we will use the publicly available [GitHub.com](https://github.com/).
...
::: {.callout-note}
If you run into trouble, please see the Install Git Mac OS section from [Happy Git and GitHub for the useR](http://happygitwithr.com/install-git.html#mac-os) for additional help or strategies for Git installation.
:::
