...
13. **(Reasoning 3 points + Writing 2 points)** Discretize one continuous numerical sensitive attribute into meaningful groups (e.g., income ranges, score bands).

14. **(Reasoning 3 points + Writing 2 points)** Apply suppression to any variable that you believe increases re-identification risk. Justify your decision.
